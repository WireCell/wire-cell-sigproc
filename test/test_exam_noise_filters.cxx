...
int main(int argc, char* argv[])
{
    ...
    WireCell::Waveform::compseq_t u_resp(nsamples);
    WireCell::Waveform::compseq_t v_resp(nsamples);
    for (int i=0;i!=120;i++){
    ...
    noise->set_response(uchans,u_resp);
    noise->set_response_offset(uchans,uplane_time_shift);
    noise->set_response(vchans,v_resp);
